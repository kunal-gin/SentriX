...
export function CommandPalette({
  ...
  const items: CommandItem[] = [
    ...
    {
      id: 'nav-databases',
      title: 'PostgreSQL & Database Internals Observability',
      category: 'Navigation',
      icon: Database,
    ...
    {
      id: 'nav-network',
      title: 'Deep Network Diagnostics & Socket States',
      category: 'Navigation',
      icon: Network,
    ...
    {
      id: 'nav-intelligence',
      title: 'SentriX Intelligence 2.0 & Evidence Graph',
      category: 'Navigation',
      icon: Sparkles,
    ...
    {
      id: 'nav-deployments',
      title: 'Deployments & Change Intelligence Correlation',
      category: 'Navigation',
      icon: Rocket,
    ...
    {
      id: 'nav-capacity',
      title: 'Capacity Planning & Cloud FinOps',
      category: 'Navigation',
      icon: TrendingUp,
    ...
    {
      id: 'nav-scale',
      title: 'High Availability & Scale Benchmarks',
      category: 'Navigation',
      icon: Zap,
      action: () => navigate('/scale'),
      shortcut: 'G S C',
    },
    {
      id: 'nav-security',
      title: 'Enterprise Security Center & SSO',
      category: 'Navigation',
      icon: Shield,
    ...
    },
    {
      ...
      title: 'Multi-Tenancy & Organization Boundaries',
      category: 'Navigation',
      icon: Building2,
    ...
    {
      id: 'nav-apikeys',
      title: 'Developer Platform & Scoped API Keys',
      category: 'Navigation',
      icon: Code,
    ...
    {
      id: 'nav-billing',
      title: 'SaaS Control Plane & Plan Management',
      category: 'Navigation',
      icon: CreditCard,
    ...
    {
      id: 'nav-compliance',
      title: 'Compliance, DR Testing & Software Bill of Materials',
      category: 'Navigation',
      icon: ShieldCheck,
